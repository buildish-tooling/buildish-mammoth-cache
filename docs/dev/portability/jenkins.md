...
Jenkins is a natural target for Mammoth Cache because it is widely used for large JVM builds and
has no native equivalent of the Gradle/Maven caching features this action provides.
