...
- [Runtime and toolchain requirements](#runtime-and-toolchain-requirements)
- [GitHub action configuration](#github-action-configuration)
  ...
  - [`cache-key-template`](#cache-key-template)
  - [`cache-partitions`](#cache-partitions)
  - [`process-all-wrapper-files`](#process-all-wrapper-files)
  - [`wrapper-properties-glob`](#wrapper-properties-glob)
  - [`wrapper-properties-files`](#wrapper-properties-files)
  - [`cleanup-enabled`](#cleanup-enabled)
  - [`restore-cleanup-mode`](#restore-cleanup-mode)
  - [`gradle-user-home`](#gradle-user-home)
  - [`setup-java`](#setup-java)
  - [`github-token`](#github-token)
- [Cache partitions and restore cleanup](#cache-partitions-and-restore-cleanup)
  - [Built-in partitions](#built-in-partitions)
  - [Include and exclude semantics](#include-and-exclude-semantics)
  - [Supported glob subset](#supported-glob-subset)
  - [Partition customization example](#partition-customization-example)
  - [Restore cleanup behavior](#restore-cleanup-behavior)
- [Usage examples](#usage-examples)
  - [Standalone — single Gradle job](#standalone--single-gradle-job)
  - [Standalone — pull-request read-only mode](#standalone--pull-request-read-only-mode)
  - [Distributed — worker and aggregator jobs](#distributed--worker-and-aggregator-jobs)
  - [Config file — centralized configuration](#config-file--centralized-configuration)
  - [Partition customization — prune kotlin-dsl, add custom partition](#partition-customization--prune-kotlin-dsl-add-custom-partition)
...
- [Security](#security)
  ...
  - [Hard cache safety exclusions](#hard-cache-safety-exclusions)
- [Maintenance notes](#maintenance-notes)
  - [Gradle signing-key rotation](#gradle-signing-key-rotation)
  - [Cache schema version](#cache-schema-version)
  - [Partition fingerprint changes](#partition-fingerprint-changes)
  - [Adding a new CI provider](#adding-a-new-ci-provider)
- [Current status](#current-status)
- [License](#license)
- [Incubation status](#incubation-status)
