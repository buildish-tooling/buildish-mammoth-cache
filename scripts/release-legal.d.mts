...
export function detectProvisionalIncompatibility(licenseExpression: string): string;
export function normalizeProjectUrl(value: unknown): string;
export function parseMode(argv: string[]): 'check' | 'check-incompatible-licenses' | 'write';
