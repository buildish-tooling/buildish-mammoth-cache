...
.PHONY: build check clean clean-all help integration-test integration-test-build-reporting integration-test-distributed-reuse integration-test-gradle-distributed-reuse integration-test-maven-distributed-reuse lint-check lint-fix rat-check rebuild release-legal-check release-legal-incompatible-license-check sanity-check smoke-test test zizmor-check
...
release-legal-incompatible-license-check: sanity-check $(NODE_MODULES_STAMP) ## Apply the provisional incompatible-license gate to bundled dependencies.
	$(NPM) run release-legal:check-incompatible-licenses
...
check: ## Run a full clean verification: clean-all, build, test, lint-check, provisional license checks, and rat-check.
	$(MAKE) clean-all
	$(MAKE) build
	$(MAKE) test
	$(MAKE) lint-check
	$(MAKE) release-legal-incompatible-license-check
	$(MAKE) rat-check
