...
# Prints and asserts the Maven action outputs for the distributed aggregator
# prepare phase, confirming both worker artifacts were downloaded and applied.
#
# Required env: ACTION_BASE_CACHE_RESTORE_STATUS, ACTION_JAVA_MAJOR,
#   ACTION_JOB_MODE, ACTION_RESOLVED_REF_NAME, ACTION_SAFE_REF_NAME,
#   ACTION_DEPENDENT_JOBS_COUNT, ACTION_DOWNLOADED_DEPENDENT_ARTIFACT_COUNT,
#   CALLER_RESOLVED_REF_NAME
...
printf '%-42s %s\n' 'downloaded-dependent-artifact-count:' "$ACTION_DOWNLOADED_DEPENDENT_ARTIFACT_COUNT"
