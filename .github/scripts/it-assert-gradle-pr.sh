...
# Prints and asserts the Gradle action outputs for the pull-request scenario,
# confirming the action defaulted to read-only mode.
#
# Required env: ACTION_BASE_CACHE_RESTORE_STATUS, ACTION_JAVA_MAJOR,
#   ACTION_JOB_MODE, ACTION_GRADLE_VERSIONS, ACTION_READ_ONLY,
#   ACTION_RESOLVED_REF_NAME, ACTION_SAFE_REF_NAME,
#   ACTION_DEPENDENT_JOBS_COUNT, CALLER_RESOLVED_REF_NAME
